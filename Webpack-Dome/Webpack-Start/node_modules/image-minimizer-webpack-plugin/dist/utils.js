...
async function imageminGenerate(original, minimizerOptions) {
  ...
  await imageminNormalizeConfig( /** @type {ImageminOptions} */ /** @type {?} */minimizerOptions || {});
...
async function sharpTransform(original, minimizerOptions = {}, targetFormat = null) {
  ...
  const outputFormat = targetFormat !== null && targetFormat !== void 0 ? targetFormat : /** @type {SharpFormat} */imageMetadata.format;
...
function sharpGenerate(original, minimizerOptions) {
  ...
  const sharpOptions = /** @type {SharpOptions} */minimizerOptions !== null && minimizerOptions !== void 0 ? minimizerOptions : {};
...
async function svgoMinify(original, minimizerOptions) {
  var _original$info$minimi3, _original$info6;
  ...
  return {
    ...
    info: {
      ...original.info,
      minimized: true,
      minimizedBy: ["svgo", ...((_original$info$minimi3 = (_original$info6 = original.info) === null || _original$info6 === void 0 ? void 0 : _original$info6.minimizedBy) !== null && _original$info$minimi3 !== void 0 ? _original$info$minimi3 : [])]
    }
  };
}
module.exports = {
